...
In R tree-structure regression models are applicable to censored responses in survival analysis. The ctree function from package `partykit`.  In the tree-structure regression the most important variable is the pnodes, number of possitive lymph nodes, corresponding to the p-value associated with the variable in the Cox regression.  
```{r}
