...
Exr3.2=read.csv(file="DataOther/EXR_C08_S03_02mod.csv", header=TRUE)
names(Exr3.2)
# PATIENT are numbers and the factor command is needed to force the 
# numbers as factors !
layout(matrix(c(1,2),nrow=1, ncol=2))
plot(TICS ~ factor(PATIENT) + factor(CONDITION), data=Exr3.2)
Exr3_2.aov = aov(TICS ~ factor(PATIENT) + factor(CONDITION), data=Exr3.2)
summary(Exr3_2.aov)
...
# with a linear model
res.add = lm(TICS ~ factor(CONDITION) + factor(PATIENT), data=Exr3.2)
res.nocond = lm(TICS ~ factor(PATIENT), data= Exr3.2)
anova(res.add, res.nocond)
Exr3_2.aov = aov(TICS ~ factor(PATIENT) + factor(CONDITION) + factor(PATIENT):factor(CONDITION), data=Exr3.2)
```
